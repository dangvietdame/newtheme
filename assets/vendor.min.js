...
function viewButtons(t, e) {
    ...
    switch (t) {
        ...
        case "getGroupElementName":
            return n;
        case "getGroupHtml":
            return '<div class="' + n.replace(/([\.#])/g, "") + '">' + ('<div class="sp-title-options">' + e.title + ': <span class="current_option_name"></span></div>') + '<ul class="sp-options-swatch options-large">' + e.html + "</ul></div>";
        case "getButtonHtml":
            var o = e.value.trim(),
                l = o.toLowerCase(),
        ...
        case "getSelectGroupHtml":
            return '<div class="' + n.replace(/([\.#])/g, "") + '">' + ('<div class="sp-title-options">' + e.title + ': <span class="current_option_name"></span></div>') + '<div class="form-default"><div class="form-group"><select class="form-control">' + e.html + "</select></div></div></div>";
...
SwatchesConstructor.prototype.destroy = function() {
    ...
    e.enableHistoryState && history.pushState(null, null, location.pathname + "?variant=" + n.id), e.createSwatches(n.id), $(e.contentParent).closest(".sp-product-single-info").find(".input_variant").val(n.id)
...
function configureQuickView(product_url, small_description, optionimages) {
    ...
    function qvLoadSuccess(json_data) {
        ...
        quickview_swatches = new SwatchesConstructor(json_data, {
            contentParent: '.sp-quickview-swatches-container-js',
...
var addToCartHandler = {
    ...
    addItem: function(line_item) {
        ...
        var sp_cb = _parent.find('.sp-cart-box');
        sp_cb.hasClass('hide') && sp_cb.removeClass('hide');
